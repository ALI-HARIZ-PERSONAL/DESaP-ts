export const questions = [
    {
        question: "Have you experienced mosquito bites within the previous 2 weeks?",
        options: ["Yes", "No"],
        points: [10, 0],
    },
    {
    ...
    {
        question: "Have you experienced biphasic fever (fever that comes and goes)?",
        options: ["Yes", "No"],
        points: [10, 0],
    },
    {
    ...
    {
        question: "Do you have retroorbital pain (pain behind the eyes)?",
        options: ["Severe", "Mild", "No"],
        points: [8, 3, 0],
    },
    {
    ...
    {
        question: "Do you have any rash? Choose all that apply.",
        options: ["Thorax", "Torso", "Back", "Limbs", "Face", "No"],
        points: [3, 3, 3, 3, 3, 0], // 3 points per selected area
    },
    {
        question: "If you have rashes, what does it look like?",
        options: ["Skin color islands in red sea", "Other", "No, don't have any rash"],
        points: [10, 5, 0],
    },
    {
        question: "When did the rash appear in relation to your fever?",
    ...
    {
        question: "Do you feel bloating or discomfort in your abdomen?",
    ...
    {
        question: "Have you experienced unusual bleeding (e.g., nosebleeds, gum bleeding, or blood in stools)?",
